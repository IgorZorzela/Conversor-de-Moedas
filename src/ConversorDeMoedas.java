...
public class ConversorDeMoedas {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      switch (selMoeda.toString()) { // should be selMoeda instead of moedas
        ...
        default:
          ...
          JOptionPane.showMessageDialog(null, "Valor inválido. Digite outro valor.", "Erro", 0);
          break;
      }

      if (resultado != null) {
        JOptionPane.showMessageDialog(null, "O resultado da conversão é: " + resultado.setScale(2, RoundingMode.HALF_UP), "Resultado", JOptionPane.INFORMATION_MESSAGE);
      }
    }
